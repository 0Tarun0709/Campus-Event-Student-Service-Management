...
class Event:
    def __init__(self, event_id: str, title: str, club: str, date: str, start_time: str, end_time: str, venue: str, max_seats: int):
    ...
    def get_summary(self) -> Dict:
        confirmed = sum(1 for reg in self.registrations if reg.status == RegistrationStatus.CONFIRMED)
        waitlisted = sum(1 for reg in self.registrations if reg.status == RegistrationStatus.WAITLISTED)

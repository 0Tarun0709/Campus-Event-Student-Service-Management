...
def manage_events():
    ...
    with st.expander("Add New Event"):
        ...
        def check_conflicts_new_event():
            ...
            class TempEvent:
                def __init__(
                    self, event_id, title, club, date, start_time, end_time, venue
                ):
                ...
                def get_conflict_details(self, other_event):
                    ...
                    if hasattr(st.session_state.system, "get_event_conflict"):
                        return st.session_state.system.get_event_conflict(
                            self, other_event
                        )
                    else:
                        ...
                        if (
                            self.venue == other_event.venue
                            and self.date == other_event.date
                        ):
    ...
    if st.session_state.system.events:
        ...
        if st.button("Register"):
            ...
            if registration:
                st.success(
                    f"Registration successful! Status: {registration.status.value}"
                )
            else:
